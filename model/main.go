...
func checkMySQLChineseSupport(db *gorm.DB) error {
	...
	if !isChineseCapable(schemaCharset, schemaCollation) {
		return fmt.Errorf("schema default charset/collation is not Chinese-capable: schema(%s/%s). Please set it to utf8mb4/utf8/gbk/big5/gb18030", schemaCharset, schemaCollation)
	}
	...
	if len(badTables) > 0 {
		...
		return fmt.Errorf("found tables that are not Chinese-capable; please fix their collation/charset. Examples (up to %d): %v", maxShow, shown)
	}
	return nil
}
