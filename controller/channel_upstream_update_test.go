...
func TestBuildUpstreamModelUpdateTaskNotificationContent_OmitOverflowDetails(t *testing.T) {
	...
	require.Contains(t, content, "The remaining 4 channels have been omitted")
	require.Contains(t, content, "the remaining 1 have been omitted")
	require.Contains(t, content, "Failed channel IDs (showing 10/12):")
	require.Contains(t, content, "the remaining 2 have been omitted")
}
